...
///
/// Built on 2025-09-23 at 22:00 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	String get appName => 'resq360';
	late final _StringsGroupsEn groups = _StringsGroupsEn._(_root);
}

// Path: groups
class _StringsGroupsEn {
	_StringsGroupsEn._(this._root);
...
class _StringsDe extends Translations {
	...
	// Translations
	@override String get appName => 'Genau richtig';
}
...
class _StringsFr extends Translations {
	...
	// Translations
	@override String get appName => 'Parfaitement adapté';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'appName': return 'resq360';
			case 'groups.searchGroups': return 'Search Groups';
			case 'groups.newGroup': return 'New Group';
			case 'groups.mute': return 'Mute';
			case 'groups.search': return 'Search';
			case 'groups.share': return 'Share';
			case 'groups.exit': return 'Exit';
			default: return null;
		}
	}
}
...
extension on _StringsDe {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'appName': return 'Genau richtig';
			default: return null;
		}
	}
}
...
extension on _StringsFr {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'appName': return 'Parfaitement adapté';
			default: return null;
		}
	}
}
