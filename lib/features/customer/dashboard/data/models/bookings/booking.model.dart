...
class User {
  User({this.id, this.fullName, this.profileImage, this.phoneNumber});
...
class ServiceCategory {
  ServiceCategory({this.id, this.name, this.description, this.image});
