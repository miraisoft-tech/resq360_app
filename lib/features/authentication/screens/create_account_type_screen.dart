...
class CreateAccountTypeScreen extends ConsumerStatefulWidget {
  const CreateAccountTypeScreen({super.key});

  @override
  ConsumerState<CreateAccountTypeScreen> createState() =>
      _CreateAccountTypeScreenState();
}

class _CreateAccountTypeScreenState
    extends ConsumerState<CreateAccountTypeScreen> {
