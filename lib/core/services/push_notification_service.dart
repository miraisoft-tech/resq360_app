...
import 'package:resq360/core/models/notifications_model.dart';
...
class NotificationService {
  ...
  var _messageSubject = BehaviorSubject<PushNotificationModel>();
  var _backgroundMessageSubject = BehaviorSubject<PushNotificationModel>();

  Stream<PushNotificationModel> get messageStream => _messageSubject.stream;
  Stream<PushNotificationModel> get backgroundMessageStream =>
  ...
  Future<void> showNotification({
    ...
    PushNotificationModel? notificationDetail;
    ...
    try {
      notificationDetail = PushNotificationModel(
        id:
            message.messageId ??
  ...
  void resetStreams() {
    ...
    _messageSubject = BehaviorSubject<PushNotificationModel>();
    _backgroundMessageSubject = BehaviorSubject<PushNotificationModel>();
  }
